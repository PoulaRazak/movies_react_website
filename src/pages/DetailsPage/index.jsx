    ...
    <>
      ...
      {loader ? <Spiner /> :
        ...
        >
          ...
          <div className="flex flex-col md:flex-row w-full gap-7 p-4 md:p-8 relative z-10">
            <div className="hover-3d flex-shrink-0 mx-auto md:mx-0">
              {/* content */}
              <figure className="w-48 sm:w-60 rounded-2xl">
                <img
            ...
            <div className="flex flex-col gap-3 text-center md:text-left">
              <p className="text-white text-2xl md:text-3xl font-bold mt-4 md:mt-8">{movie.title}</p>
              <div className="flex flex-row flex-wrap justify-center md:justify-start gap-2 text-sm">
                <p>
              ...
              <p>{movie.overview}</p>
              <div className="flex flex-row items-center justify-center md:justify-start gap-3 my-2">
